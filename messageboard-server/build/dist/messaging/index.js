...
exports.publishMessage = exports.messageTopic = void 0;
var loggers_1 = require("../util/loggers");
var PubSub = require('@google-cloud/pubsub').PubSub;
// $ npm install @google-cloud/pubsub
var pubSubClient = new PubSub();
var topicName = ('projects/message-board-284300/topics/message-board-topic');
exports.messageTopic = pubSubClient.topic(topicName);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, exports.messageTopic.publishJSON(message)];
                case 1:
                    messageId = _a.sent();
                    loggers_1.logger.debug("Pub/Sub message " + messageId + " published.");
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    loggers_1.logger.error("Pub/Sub message error " + error_1);
                    return [3 /*break*/, 3];
